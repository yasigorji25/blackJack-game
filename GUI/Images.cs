...
namespace GUI {
    ...
    public static class Images {
        ...
        static Images() {
            ...
            for (Suit suit = Suit.Clubs; suit <= Suit.Spades; suit++) {
                for (FaceValue faceValue = FaceValue.Ace; faceValue <= FaceValue.King; faceValue++) {
                    ...
                    cardImages[(int)card.Suit, (int)card.FaceValue-1] = LoadImage("Cards", cardImageName);
                }
            } //end for(Suit suit ...      
        ...
        private static string GetCardImageName(Card card) {
            Suit suit = card.Suit;
            FaceValue faceValue = card.FaceValue;
        ...
        public static Bitmap GetCardImage(Card card) {
            return cardImages[(int)card.Suit, (int)card.FaceValue-1];
        }
